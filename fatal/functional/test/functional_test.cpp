...
# define TEST_IMPL(Expected, ...) \
  ...
  TEST_IMPL(1, 1);
  TEST_IMPL(999, 999);
  TEST_IMPL(0xfaceb00c, 0xfaceb00c);

  TEST_IMPL((0 & 0), 0, 0);
  TEST_IMPL((0 & 1), 0, 1);
  TEST_IMPL((0 & 999), 0, 999);
  TEST_IMPL((0 & 0xfaceb00c), 0, 0xfaceb00c);
  TEST_IMPL((1 & 0), 1, 0);
  TEST_IMPL((1 & 1), 1, 1);
  TEST_IMPL((1 & 999), 1, 999);
  TEST_IMPL((1 & 0xfaceb00c), 1, 0xfaceb00c);
  TEST_IMPL((999 & 0), 999, 0);
  TEST_IMPL((999 & 1), 999, 1);
  TEST_IMPL((999 & 999), 999, 999);
  TEST_IMPL((999 & 0xfaceb00c), 999, 0xfaceb00c);
  TEST_IMPL((0xfaceb00c & 0), 0xfaceb00c, 0);
  TEST_IMPL((0xfaceb00c & 1), 0xfaceb00c, 1);
  TEST_IMPL((0xfaceb00c & 999), 0xfaceb00c, 999);
  TEST_IMPL((0xfaceb00c & 0xfaceb00c), 0xfaceb00c, 0xfaceb00c);

  TEST_IMPL((0 & 0 & 0), 0, 0, 0);
  TEST_IMPL((0 & 0 & 1), 0, 0, 1);
  TEST_IMPL((0 & 0 & 999), 0, 0, 999);
  TEST_IMPL((0 & 0 & 0xfaceb00c), 0, 0, 0xfaceb00c);
  TEST_IMPL((0 & 1 & 0), 0, 1, 0);
  TEST_IMPL((0 & 1 & 1), 0, 1, 1);
  TEST_IMPL((0 & 1 & 999), 0, 1, 999);
  TEST_IMPL((0 & 1 & 0xfaceb00c), 0, 1, 0xfaceb00c);
  TEST_IMPL((0 & 999 & 0), 0, 999, 0);
  TEST_IMPL((0 & 999 & 1), 0, 999, 1);
  TEST_IMPL((0 & 999 & 999), 0, 999, 999);
  TEST_IMPL((0 & 999 & 0xfaceb00c), 0, 999, 0xfaceb00c);
  TEST_IMPL((0 & 0xfaceb00c & 0), 0, 0xfaceb00c, 0);
  TEST_IMPL((0 & 0xfaceb00c & 1), 0, 0xfaceb00c, 1);
  TEST_IMPL((0 & 0xfaceb00c & 999), 0, 0xfaceb00c, 999);
  TEST_IMPL((0 & 0xfaceb00c & 0xfaceb00c), 0, 0xfaceb00c, 0xfaceb00c);
  TEST_IMPL((1 & 0 & 0), 1, 0, 0);
  TEST_IMPL((1 & 0 & 1), 1, 0, 1);
  TEST_IMPL((1 & 0 & 999), 1, 0, 999);
  TEST_IMPL((1 & 0 & 0xfaceb00c), 1, 0, 0xfaceb00c);
  TEST_IMPL((1 & 1 & 0), 1, 1, 0);
  TEST_IMPL((1 & 1 & 1), 1, 1, 1);
  TEST_IMPL((1 & 1 & 999), 1, 1, 999);
  TEST_IMPL((1 & 1 & 0xfaceb00c), 1, 1, 0xfaceb00c);
  TEST_IMPL((1 & 999 & 0), 1, 999, 0);
  TEST_IMPL((1 & 999 & 1), 1, 999, 1);
  TEST_IMPL((1 & 999 & 999), 1, 999, 999);
  TEST_IMPL((1 & 999 & 0xfaceb00c), 1, 999, 0xfaceb00c);
  TEST_IMPL((1 & 0xfaceb00c & 0), 1, 0xfaceb00c, 0);
  TEST_IMPL((1 & 0xfaceb00c & 1), 1, 0xfaceb00c, 1);
  TEST_IMPL((1 & 0xfaceb00c & 999), 1, 0xfaceb00c, 999);
  TEST_IMPL((1 & 0xfaceb00c & 0xfaceb00c), 1, 0xfaceb00c, 0xfaceb00c);
  TEST_IMPL((999 & 0 & 0), 999, 0, 0);
  TEST_IMPL((999 & 0 & 1), 999, 0, 1);
  TEST_IMPL((999 & 0 & 999), 999, 0, 999);
  TEST_IMPL((999 & 0 & 0xfaceb00c), 999, 0, 0xfaceb00c);
  TEST_IMPL((999 & 1 & 0), 999, 1, 0);
  TEST_IMPL((999 & 1 & 1), 999, 1, 1);
  TEST_IMPL((999 & 1 & 999), 999, 1, 999);
  TEST_IMPL((999 & 1 & 0xfaceb00c), 999, 1, 0xfaceb00c);
  TEST_IMPL((999 & 999 & 0), 999, 999, 0);
  TEST_IMPL((999 & 999 & 1), 999, 999, 1);
  TEST_IMPL((999 & 999 & 999), 999, 999, 999);
  TEST_IMPL((999 & 999 & 0xfaceb00c), 999, 999, 0xfaceb00c);
  TEST_IMPL((999 & 0xfaceb00c & 0), 999, 0xfaceb00c, 0);
  TEST_IMPL((999 & 0xfaceb00c & 1), 999, 0xfaceb00c, 1);
  TEST_IMPL((999 & 0xfaceb00c & 999), 999, 0xfaceb00c, 999);
  TEST_IMPL((999 & 0xfaceb00c & 0xfaceb00c), 999, 0xfaceb00c, 0xfaceb00c);
  TEST_IMPL((0xfaceb00c & 0 & 0), 0xfaceb00c, 0, 0);
  TEST_IMPL((0xfaceb00c & 0 & 1), 0xfaceb00c, 0, 1);
  TEST_IMPL((0xfaceb00c & 0 & 999), 0xfaceb00c, 0, 999);
  TEST_IMPL((0xfaceb00c & 0 & 0xfaceb00c), 0xfaceb00c, 0, 0xfaceb00c);
  TEST_IMPL((0xfaceb00c & 1 & 0), 0xfaceb00c, 1, 0);
  TEST_IMPL((0xfaceb00c & 1 & 1), 0xfaceb00c, 1, 1);
  TEST_IMPL((0xfaceb00c & 1 & 999), 0xfaceb00c, 1, 999);
  TEST_IMPL((0xfaceb00c & 1 & 0xfaceb00c), 0xfaceb00c, 1, 0xfaceb00c);
  TEST_IMPL((0xfaceb00c & 999 & 0), 0xfaceb00c, 999, 0);
  TEST_IMPL((0xfaceb00c & 999 & 1), 0xfaceb00c, 999, 1);
  TEST_IMPL((0xfaceb00c & 999 & 999), 0xfaceb00c, 999, 999);
  TEST_IMPL((0xfaceb00c & 999 & 0xfaceb00c), 0xfaceb00c, 999, 0xfaceb00c);
  TEST_IMPL((0xfaceb00c & 0xfaceb00c & 0), 0xfaceb00c, 0xfaceb00c, 0);
  TEST_IMPL((0xfaceb00c & 0xfaceb00c & 1), 0xfaceb00c, 0xfaceb00c, 1);
  TEST_IMPL((0xfaceb00c & 0xfaceb00c & 999), 0xfaceb00c, 0xfaceb00c, 999);
  TEST_IMPL(
    (0xfaceb00c & 0xfaceb00c & 0xfaceb00c),
    0xfaceb00c, 0xfaceb00c, 0xfaceb00c
  );
