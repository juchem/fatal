...
# define FATAL_IMPL_GET_TYPE_TYPE(Name) \
  ...
  FATAL_IMPL_GET_TYPE_TYPE(rule);
  FATAL_IMPL_GET_TYPE_TYPE(rules);
  ...
  FATAL_IMPL_GET_TYPE_TYPE(symbol);
  FATAL_IMPL_GET_TYPE_TYPE(symbols);
  FATAL_IMPL_GET_TYPE_TYPE(tag);
  FATAL_IMPL_GET_TYPE_TYPE(third);
  FATAL_IMPL_GET_TYPE_TYPE(token);
...
#endif // FATAL_INCLUDE_fatal_type_get_type_h
