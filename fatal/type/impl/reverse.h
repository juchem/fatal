...
struct R<T0, T1, T2, T3, T4, T5, T6, T7, U0, U1> {
  template <template <typename...> class T, typename... Suffix>
  using apply = apply_args<T, U1, U0, T7, T6, T5, T4, T3, T2, T1, T0, Suffix...>;
};

template <
  typename T0, typename T1, typename T2, typename T3,
  typename T4, typename T5, typename T6, typename T7, typename U0, typename U1, typename U2
>
struct R<T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2> {
  template <template <typename...> class T, typename... Suffix>
  using apply = apply_args<T, U2, U1, U0, T7, T6, T5, T4, T3, T2, T1, T0, Suffix...>;
};
...
struct R<T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2, U3> {
  template <template <typename...> class T, typename... Suffix>
  using apply = apply_args<T, U3, U2, U1, U0, T7, T6, T5, T4, T3, T2, T1, T0, Suffix...>;
};
...
struct R<T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2, U3, U4> {
  template <template <typename...> class T, typename... Suffix>
  using apply = apply_args<T, U4, U3, U2, U1, U0, T7, T6, T5, T4, T3, T2, T1, T0, Suffix...>;
};
...
struct R<T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2, U3, U4, U5> {
  template <template <typename...> class T, typename... Suffix>
  using apply = apply_args<T, U5, U4, U3, U2, U1, U0, T7, T6, T5, T4, T3, T2, T1, T0, Suffix...>;
};
...
template <
  ...
  typename... Tail
>
struct R<T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2, U3, U4, U5, U6, U7, Tail...> {
  template <template <typename...> class T, typename... Suffix>
...
template <template <typename V, V...> class Sequence, typename T, T T0, T T1, T T2>
struct S<Sequence<int>, T, T0, T1, T2> {
  template <T... Suffix>
  using apply = Sequence<T, T2, T1, T0, Suffix...>;
};

template <template <typename V, V...> class Sequence, typename T, T T0, T T1, T T2, T T3>
struct S<Sequence<int>, T, T0, T1, T2, T3> {
  template <T... Suffix>
  using apply = Sequence<T, T3, T2, T1, T0, Suffix...>;
};

template <template <typename V, V...> class Sequence, typename T, T T0, T T1, T T2, T T3, T T4>
...
struct S<Sequence<int>, T, T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2> {
  template <T... Suffix>
  using apply = Sequence<T, U2, U1, U0, T7, T6, T5, T4, T3, T2, T1, T0, Suffix...>;
};
...
struct S<Sequence<int>, T, T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2, U3> {
  template <T... Suffix>
  using apply = Sequence<T, U3, U2, U1, U0, T7, T6, T5, T4, T3, T2, T1, T0, Suffix...>;
};
...
struct S<Sequence<int>, T, T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2, U3, U4> {
  template <T... Suffix>
  using apply = Sequence<T, U4, U3, U2, U1, U0, T7, T6, T5, T4, T3, T2, T1, T0, Suffix...>;
};

template <
  template <typename V, V...> class Sequence, typename T,
  T T0, T T1, T T2, T T3, T T4, T T5, T T6, T T7, T U0, T U1, T U2, T U3, T U4, T U5
>
struct S<Sequence<int>, T, T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2, U3, U4, U5> {
  template <T... Suffix>
  using apply = Sequence<T, U5, U4, U3, U2, U1, U0, T7, T6, T5, T4, T3, T2, T1, T0, Suffix...>;
};

template <
  template <typename V, V...> class Sequence, typename T,
  T T0, T T1, T T2, T T3, T T4, T T5, T T6, T T7, T U0, T U1, T U2, T U3, T U4, T U5, T U6
>
struct S<Sequence<int>, T, T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2, U3, U4, U5, U6> {
  template <T... Suffix>
  using apply = Sequence<T, U6, U5, U4, U3, U2, U1, U0, T7, T6, T5, T4, T3, T2, T1, T0, Suffix...>;
};

template <
  template <typename V, V...> class Sequence, typename T,
  T T0, T T1, T T2, T T3, T T4, T T5, T T6, T T7, T U0, T U1, T U2, T U3, T U4, T U5, T U6, T U7,
  T... Tail
>
struct S<
  Sequence<int>, T, T0, T1, T2, T3, T4, T5, T6, T7, U0, U1, U2, U3, U4, U5, U6, U7, Tail...
> {
  template <T... Suffix>
